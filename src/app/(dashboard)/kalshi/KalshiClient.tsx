                ...
                {(() => {
                  ...
                  return (
                    <div className="home-carousel-card" style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "minmax(260px, 40%) minmax(0, 1fr)", gridTemplateRows: isMobile ? "auto minmax(0, 1fr)" : undefined, width: "100%", height: "100%", minHeight: 0, gap: isMobile ? 10 : 12, background: "transparent" }}>
                      ...
                      <div className="home-carousel-right" style={{ display: "flex", flexDirection: "column", width: "100%", height: "100%", alignSelf: "stretch", boxSizing: "border-box", background: "#050505", padding: isMobile ? "16px 20px 16px" : "24px 28px 18px", borderRadius: 10, position: "relative", minWidth: 0, overflow: "hidden", minHeight: 0 }}>
