...
const MODES = [
  {
    ...
    desc: "Crowd vs AI — simulate prediction market outcomes.",
  ...
  },
  {
    ...
    active: false,
    color: "var(--accent)",
    bg: "linear-gradient(160deg,#0f172a,var(--accent))",
  },
  {
    icon: Rocket,
...
> = {
  ...
  policy: { icon: ShieldAlert, color: "var(--accent)", label: "Policy" },
      ...
      >
        <motion.div
          ...
          style={{
            height: "100%",
            borderRadius: 99,
            background: `linear-gradient(90deg, #22c55e 0%, #ffffff 40%, var(--accent) 70%, #ef4444 100%)`,
...
function NewsDetailPanel({
  ...
  const handleSimulate = () => {
    router.push(
      `/simulate/mirofish?prefill=${encodeURIComponent(topic.topic + ": " + topic.impact)}`,
    );
  };
      ...
      >
        ...
        <div style={{ padding: "20px 24px 0" }}>
          <motion.button
            ...
            style={{
              ...
              justifyContent: "center",
              gap: 10,
              boxShadow: "0 4px 30px rgba(255, 255, 255,0.4)",
            }}
          >
            <Zap size={18} fill="white" />
            Run Full Simulation on This Event
            <ArrowRight size={18} />
          </motion.button>
        </div>
        ...
        >
          ...
          >
            ...
            <WorldMap category={topic.category} size="small" />
          </motion.div>
            ...
            {(isBreaking || isHot) && (
              <motion.div
                ...
                style={{
                  ...
                  height: 7,
                  borderRadius: "50%",
                  background: isBreaking ? "#ef4444" : "var(--accent)",
    ...
    topics.length > 0
      ? topics.map((t) => {
          if (t.type === "prediction") {
            ...
            return `🎯 ${t.topic} → HEMLO ${t.hemloOdds ?? "?"}% · Crowd ${t.polymarketOdds ?? "??"} · ${div >= 0 ? "⚡+" : ""}${div}%`;
          }
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Target size={11} color="var(--accent)" /> Top Predictions
        </div>
        <Link
          href="/markets"
          style={{
          ...
          <div style={{ display: "flex", gap: 6 }}>
            ...
            <button
              ...
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                opacity: activeIdx === MODES.length - 1 ? 0.3 : 1,
              }}
            >
        ...
        >
          {MODES.map((mode, i) => {
            ...
            return (
              ...
              >
                <motion.div
                  whileHover={mode.active ? { y: -4, scale: 1.02 } : {}}
                  style={{
                    width: 200,
                    height: 220,
                    borderRadius: 14,
